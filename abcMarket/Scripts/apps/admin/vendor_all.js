...
"columns": [
        ...
        "data": "rowid", "width": "60px", "orderable": false, "render": function (data) {
                        return '<a class="popup" title="修改記錄" href="/Admin/Vendor/Edit/' + data + '"><i class="fas fa-edit fa-2x"></i></a>' +
                            '<a class="popup" title="刪除記錄" href="/Admin/Vendor/Delete/' + data + '"><i class="fas fa-trash-alt fa-2x"></i></a>' +
                            '<a class="popup" title="重設密碼" href="/Admin/Vendor/Reset/' + data + '"><i class="fas fa-key fa-2x"></i></a>';
}
},
                {
